...
from decompComponents.models.decomposition.stl import stl_model

from decompComponents.functions import decompose_multivariate

from decompComponents.models.deepLearning.multivariate.multi_lstm import multi_LSTM
from decompComponents.models.deepLearning.multivariate.multi_gru import multi_GRU
from decompComponents.models.deepLearning.multivariate.multi_cnn import multi_CNN
from decompComponents.models.deepLearning.multivariate.multi_cnn_gru import multi_CNN_GRU
from decompComponents.models.deepLearning.multivariate.multi_cnn_lstm import multi_CNN_LSTM
...
options = ["Select", "STL"]
model_option = st.sidebar.selectbox("Choose a Decomposition method", options)
...
if node and edge :
    ...
    if option == "Univariate":
        ...
        options = ["Select","Traditional","Deep Learning"]
        model_option = st.selectbox("Choose a model",options)

        if model_option == "Traditional" :

            trend_data , seasonal_data , residue_data = decompose_multivariate(selected_node_data=selected_node_data)

            st.write("Trend data")
            st.write(trend_data)
            st.write("Seasonal data")
            st.write(seasonal_data)
            st.write("Residue data")
            st.write(residue_data)
